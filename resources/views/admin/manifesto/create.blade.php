...
@section('content_header')
    <h1 class="m-0 text-dark">Novo Manifesto <a href="{{route('admin.frota.index')}}" class="btn btn-warning float-right"><i class="fas fa-arrow-left"></i>&nbsp;Voltar</a></h1>
@stop
