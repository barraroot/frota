    ...
    */
    ...
    'menu' => [
        ...
        */
        ...
        [
            'text' => 'Manifesto de Viagem',
            'url'  => 'admin/manifesto',
            'icon' => 'fas fa-shuttle-van'
        ],
        [
            'text' => 'Controle de Abastecimento',
            'url'  => 'admin/manifestos',
            'icon' => 'fas fa-gas-pump'
        ],        
        ['header' => 'Relatório'],
        [
            'text' => 'Orçamentos',
            'url'  => 'admin/movimentos',
        ...
        'CkEditor' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => 'https://cdn.ckeditor.com/ckeditor5/34.2.0/classic/ckeditor.js'
                ]
            ]
        ]
    ],
